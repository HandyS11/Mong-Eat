...
public class RestaurantStub {
    ...
    public RestaurantStub() {
        RestaurantEntity restaurant1 = new RestaurantEntity("647998cb5c47e8017481fb87", "Chez patrick", "https://media-cdn.tripadvisor.com/media/photo-s/16/54/07/1c/chez-patrick-un-havre.jpg", 6.5 , List.of("64705dda1fe1d56fab1b17b2"), List.of(new CategoryEntity("Kebab", "")), LocationStub.location1);
        RestaurantEntity restaurant2 = new RestaurantEntity("6479996ed405d82d32828e8d", "Le patoche", "https://media-cdn.tripadvisor.com/media/photo-s/11/75/ca/ca/un-havre-de-paix-au-coeur.jpg", 8.5, List.of("64705e06ae09d7bf1afc23ff", "64705e5df7e8ac3405332f57"), List.of(new CategoryEntity("Pizzeria", ""), new CategoryEntity("Japonais", "")), LocationStub.location1);
        RestaurantEntity restaurant3 = new RestaurantEntity("64799a051e8356531edb5725", "Le all in one", "https://www.theolivepress.es/wp-content/uploads/2022/03/All-in-1-Cafe-5.jpg", 9.5, List.of("64705e9520469bd3b59ec539", "64705dcabd367e78ccaddbe0", "64705dda1fe1d56fab1b17b2"), List.of(new CategoryEntity("Tout", ""), new CategoryEntity("Vraiment tout", "")), LocationStub.location1);
